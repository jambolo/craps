PAYOUT_DONT = 1 + 1 # 1 to 1
PAYOUT_ODDS_4_10 = 1 + 1 / 2 # 1 to 2
PAYOUT_ODDS_5_9 = 1 + 2 / 3 # 2 to 3
PAYOUT_ODDS_6_8 = 1 + 5 / 6 # 5 to 6
NTRIALS = 10000000
...
console.log "wins = #{wins} (#{Number(wins/NTRIALS*100).toFixed(1)}%), return = #{Number(PAYOUT_DONT*wins/NTRIALS).toFixed(3)}"
